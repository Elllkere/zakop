...
var ru = {
	...
	'Outbound not found': 'Исходящий не найден',
	...
	'Outbound pools': 'Пулы исходящих',
	'Outbound pool details': 'Детали пула исходящих',
	'A pool checks members in the displayed order, uses the first reachable outbound, and automatically returns to a higher-priority member after it recovers.': 'Пул проверяет участников в указанном порядке, использует первый доступный исходящий и автоматически возвращается на более приоритетный после его восстановления.',
	'Pool: %s': 'Пул: %s',
	'Priority order': 'Порядок приоритета',
	'The top outbound has the highest priority. The next one is used only when every outbound above it is unavailable.': 'Самый верхний исходящий имеет наивысший приоритет. Следующий используется только тогда, когда недоступны все исходящие выше него.',
	'Unknown outbound: %s': 'Неизвестный исходящий: %s',
	'Health check URL': 'URL проверки доступности',
	'Check interval (seconds)': 'Интервал проверки (секунды)',
	'Flow': 'Flow',
	'None': 'Нет',
